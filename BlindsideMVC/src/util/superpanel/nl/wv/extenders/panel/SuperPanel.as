/********************************************
 ...
 date    : 2007-03-30
********************************************/
package superpanel.nl.wv.extenders.panel {
...
//		[Embed(source="/assets/superpanel/img/resizeCursor.png")]
//		private static var resizeCursor:Class;
		...
		protected var showCloseButton:Boolean = false;
				  ...
				  if(showCloseButton)
				    {
						...
						this.normalMaxButton.x = this.unscaledWidth - this.normalMaxButton.width - 28;
		...
		public function normalMaxClickHandler(event:MouseEvent):void {
			if (this.normalMaxButton.styleName == "increaseBtn") {
				if (this.height > 28) {
					...
					this.x = 0;
					this.y = 0;
					this.width = (screen.width/100) * 90; // occupy 90% of screen
					this.height = (screen.height/100) * 90; // occupy 90% of screen
