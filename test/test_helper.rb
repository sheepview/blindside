...
class Test::Unit::TestCase
  ...
  # Assert existence of form input fields with attributes.
  def assert_input_field(name, value, field_type, size, maxlength, options ={})
    ...
    # Merge tag hash with options, expecially to handle :parent => error_div
  ...
  def assert_length(boundary, object, attribute, length, options = {})
   ...
   # Return the correct error message for the length of test.
