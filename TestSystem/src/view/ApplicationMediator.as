package view
{
	...
	public class ApplicationMediator extends Mediator implements IMediator
	{
		 ...
		 * 
		 */		
		public function ApplicationMediator(viewComponent:TestSystem)
		{
			
			super(NAME, viewComponent);
			facade.registerMediator(new TestMediator(viewComponent.test));
		}
		 ...
		 * 
		 */		
		protected function get app():TestSystem
		{
            return viewComponent as TestSystem;
        }
