package org.blindsideproject.core.apps.conference.controller
{
	...
	public class ConferenceController extends FrontController
	{
		...
		public function ConferenceController()
		{
			...
			addCommand(ConferenceController.BROADCAST_STREAM_COMMAND, BroadcastStreamCommandHandler);		
		}
		...
		public static const BROADCAST_STREAM_COMMAND : String = "CONFERENCE_BROADCAST_STREAM_COMMAND";	
	}
}