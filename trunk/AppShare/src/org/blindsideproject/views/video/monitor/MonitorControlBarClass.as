package org.red5.samples.publisher.view.monitor
{
	...
	import org.red5.samples.publisher.view.monitor.*;
	import mx.containers.Canvas;
	import org.red5.samples.publisher.view.settings.*;
	...
	{		
		...
		*/		
		...
		[Bindable]
		public var mdc : MonitorDisplayClass;
		...
		public function viewStream() : void
		{
			...
			if ( main.netConnected ) 
			{
				...
				else if ( main.playbackState == main.stopState )
				{
					...
					var playStreamEvent : PlayStreamEvent = new PlayStreamEvent( bufferTime, streamName,true,true);
		...
		{
			var publishMode : String = main.publishTypes[0].data;//publish_cb.selectedItem.data;
